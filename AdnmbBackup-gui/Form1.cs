...
namespace AdnmbBackup_gui
{
    public partial class Form1 : Form
    {
        ...
        static void ConvertToText(string path)
        {
            ...
            File.WriteAllText(path.Replace("json", "txt"), sb.ToString(), Encoding.GetEncoding("GBK"));
        }
        static void ConvertToTextPoOnly(string path)
        {
            ...
            File.WriteAllText(path.Replace(".json", "_po_only.txt"), sb.ToString(), Encoding.GetEncoding("GBK"));
        }
