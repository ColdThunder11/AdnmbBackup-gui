...
namespace AdnmbBackup_gui
{
    public partial class Form1 : Form
    {
        ...
        static void ConvertToText(string path)
        {
            ...
            File.WriteAllText(path.Replace("json", "txt").Replace("cache", "output"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
            File.WriteAllText(path.Replace("json", "txt").Replace("cache", "output\\all"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
        }
        static void ConvertToTextPoOnly(string path)
        {
            ...
            File.WriteAllText(path.Replace(".json", "_po_only.txt").Replace("cache", "output"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
            File.WriteAllText(path.Replace(".json", "_po_only.txt").Replace("cache", "output\\po"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
        }
        static void ConvertToMarkdown(string path)
        {
            ...
            File.WriteAllText(path.Replace("json", "md").Replace("cache", "output"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
            File.WriteAllText(path.Replace("json", "md").Replace("cache", "output\\all"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
        }
        static void ConvertToMarkdownPoOnly(string path)
        {
            ...
            File.WriteAllText(path.Replace(".json", "_po_only.md").Replace("cache", "output"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
            File.WriteAllText(path.Replace(".json", "_po_only.md").Replace("cache", "output\\po"), sb.ToString(), System.Text.Encoding.GetEncoding("UTF8"));
        }
